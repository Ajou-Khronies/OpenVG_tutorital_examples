...
HINSTANCE g_hInst;
LPSTR lpszClass="OVG PG: Sample 07_03";
...
int AppDisplay( void )
{
    ...
    vgWritePixels(cimg_flower, 4*240, VG_sRGBA_8888, 15,30, 120,120);
    vgCopyPixels(135, 30, 75, 90, 60, 60);
    vgCopyPixels(195, 30, 105, 120, 30,30);

    vgWritePixels(cimg_flower, 4*240, VG_sRGBA_8888, 15,165, 120,120);
    clearColor[0] = clearColor[1] = 0.0;
    vgSetfv(VG_CLEAR_COLOR, 4, clearColor);
    vgClear(120, 270,15,15);
    vgCopyPixels(135, 165, 75, 225, 60, 60);
    vgCopyPixels(195, 165, 105, 255, 30,30);
