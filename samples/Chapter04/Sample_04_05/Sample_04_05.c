...
HINSTANCE g_hInst;
LPSTR lpszClass="OVG PG: Sample 04_05";
...
int AppDisplay( void )
{
    ...
    VGubyte segments[] = { VG_MOVE_TO_ABS, VG_LINE_TO_ABS,
                            VG_SCCWARC_TO_ABS, VG_LINE_TO_ABS,
                            VG_CLOSE_PATH };
    VGfloat coords[] = { 40.0f, 80.0f, // VG_MOVE_TO_ABS
                        120.0f, 80.0f, // VG_LINE_TO_ABS
                        80.0f, 80.0f, 0.0f, 200.0f, 160.0f, // VG_SCCWARC_TO_ABS        
                        // rh, rv, rot, x0, y0
                        200.0f, 240.0f }; // VG_LINE_TO_ABS
