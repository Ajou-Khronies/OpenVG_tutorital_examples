...
HINSTANCE g_hInst;
LPSTR lpszClass="OVG PG: Sample 04_04";
...
{
    VGPath path;
    VGubyte segments[] = { VG_MOVE_TO_ABS, VG_QUAD_TO_ABS, VG_QUAD_TO_ABS,
                            VG_MOVE_TO_ABS, VG_QUAD_TO_ABS, VG_SQUAD_TO_ABS};
    VGfloat coords[] = { 20.0f, 100.0f, // VG_MOVE_TO_ABS
                         70.0f, 50.0f, 120.0f, 100.0f, // VG_QUAD_TO_ABS
                         170.0f, 150.0f, 220.0f, 100.0f, // VG_QUAD_TO_ABS
                         20.0f, 220.0f, // VG_MOVE_TO_ABS
                         70.0f, 170.0f, 120.0f, 220.0f, // VG_QUAD_TO_ABS
                         /* NO COORD */ 220.0f, 220.0f}; // VG_SQUAD_TO_ABS
