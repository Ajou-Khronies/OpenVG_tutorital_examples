...
HINSTANCE g_hInst;
LPSTR lpszClass="OVG PG: Sample 04_06B";
...
int AppDisplay( void )
{
    ...
    VGfloat coordMoon[] = { 208.0f, 220.0f, 45.0f, 45.0f, 0.0f, 240.0f, 144.0f, 45.0f, 45.0f, 0.0f, 208.0f, 220.0f };
    VGPath mountAndMoonPath;

    VGfloat clearColor[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
    vgSetfv( VG_CLEAR_COLOR, 4, clearColor );
    vgClear( 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT );

    mountAndMoonPath = vgCreatePath(VG_PATH_FORMAT_STANDARD, VG_PATH_DATATYPE_F, 1, 0, 0, 0, VG_PATH_CAPABILITY_ALL );
    vgAppendPathData( mountAndMoonPath, 6, cmdMountain, coordMountain );
    vgAppendPathData( mountAndMoonPath, 3, cmdMoon, coordMoon );

    vgDrawPath( mountAndMoonPath, VG_FILL_PATH );
    vgDestroyPath( mountAndMoonPath );
