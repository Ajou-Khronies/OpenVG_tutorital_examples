...
HINSTANCE g_hInst;
LPSTR lpszClass="OVG PG: Sample 04_02";
...
int AppDisplay( void )
{
    ...
    VGubyte segments[] = { VG_MOVE_TO_ABS, VG_LINE_TO_ABS, VG_LINE_TO_ABS,
                           ...
                           VG_MOVE_TO_REL, VG_HLINE_TO_REL, VG_VLINE_TO_REL,
                           VG_HLINE_TO_REL, VG_CLOSE_PATH };

    VGfloat coords[] = { 10.0f, 50.0f, // VG_MOVE_TO_ABS
                         110.0f, 50.0f, // VG_LINE_TO_ABS
                         110.0f, 150.0f, // VG_LINE_TO_ABS
                         10.0f, 150.0f, // VG_LINE_TO_REL
                         130.0f, 50.0f, // VG_MOVE_TO_ABS
                         100.0f, 0.0f, // VG_LINE_TO_REL
                         0.0f, 100.0f, // VG_LINE_TO_REL
                        -100.0f, 0.0f, // VG_LINE_TO_REL
                         0.0f, 120.0f, // VG_MOVE_TO_REL
                         100.0f, // VG_HLINE_TO_REL
                         100.0f, // VG_VLINE_TO_REL
                        -100.0 }; // VG_HLINE_TO_REL
    ...
    vgAppendPathData( path, 15, segments, coords );
