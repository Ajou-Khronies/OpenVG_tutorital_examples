...
HINSTANCE g_hInst;
LPSTR lpszClass="OVG PG: Sample 13_06";
...
int AppDisplay( void )
{
    ...
    vguArc( path, 40.0f, 20.0f, 300.0f, 150.0f, 0.0f, 90.0f, VGU_ARC_OPEN );
    vguArc( path, 40.0f, 120.0f, 300.0f, 150.0f, 0.0f, 90.0f, VGU_ARC_PIE );
    vguArc( path, 40.0f, 220.0f, 300.0f, 150.0f, 0.0f, 90.0f, VGU_ARC_CHORD );
