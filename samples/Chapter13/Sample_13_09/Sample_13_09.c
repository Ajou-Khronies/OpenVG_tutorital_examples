...
HINSTANCE g_hInst;
LPSTR lpszClass="OVG PG: Sample 13_09";
...
int AppDisplay( void )
{
    ...
    dx1 = 164.0f, dy1 = 0.0f;
    dx2 = 0.0f, dy2 = 264.0f;
    dx3 = 260.0f, dy3 = 260.0f;

    vgSetfv(VG_CLEAR_COLOR, 4, clearColor);
    vgClear(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
    vguErr = vguComputeWarpQuadToQuad(dx0, dy0, dx1, dy1, dx2, dy2, dx3, dy3,
    sx0, sy0, sx1, sy1, sx2, sy2, sx3, sy3, m);
