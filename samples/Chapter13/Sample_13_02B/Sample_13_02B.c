...
HINSTANCE g_hInst;
LPSTR lpszClass="OVG PG: Sample 13_02_b";
...
int AppDisplay( void )
{
    ...
    VGfloat points1[] = { 50.0f, 50.0f, 190.0f, 50.0f, 190.0f, 230.0f };
    VGfloat points2[] = { 20.0f, 80.0f, 160.0f, 80.0f, 160.0f, 260.0f };
    ...
    vguPolygon(path, points1, 3, VG_FALSE);
    vguPolygon(path, points2, 3, VG_TRUE);
