...
HINSTANCE g_hInst;
LPSTR lpszClass="OVG PG: Sample 05_03";
...
int AppDisplay( void )
{
    ...
    VGfloat coords[] = { 50.0f, 50.0f, 190.0f, 50.0f, 90.0f, 150.0f };
    VGfloat clear[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
    VGfloat dashPattern[4] = {10.0, 20.0, 30.0, 40.0};
