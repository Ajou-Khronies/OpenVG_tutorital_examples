...
HINSTANCE g_hInst;
LPSTR lpszClass="OVG PG: Sample 05_04";
...
{
    VGPath path;
    VGubyte segments[] = { VG_MOVE_TO_ABS, VG_LINE_TO_REL,
                            VG_LINE_TO_REL, VG_LINE_TO_REL, VG_CLOSE_PATH,
                            VG_MOVE_TO_ABS, VG_LINE_TO_REL,
                            VG_LINE_TO_REL, VG_LINE_TO_REL, VG_CLOSE_PATH };
    VGfloat coords[] = { 75.0f, 50.0f, 90.0f, 0.0f,
                          0.0f, 90.0f, -90.0f, 0.0f,
                         75.5f, 160.5f, 90.0f, 0.0f,
                          0.0f, 90.0f, -90.0f, 0.0f };
    ...
    vgAppendPathData( path, 10, segments, coords );
