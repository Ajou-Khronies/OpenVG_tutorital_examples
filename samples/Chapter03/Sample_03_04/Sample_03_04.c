...
HINSTANCE g_hInst;
LPSTR lpszClass="OVG PG: Sample 03_04";
...
int AppDisplay( void )
{
    ...
    VGfloat coords[] = { 50.0f, 100.0f, // VG_MOVE_TO_ABS
                         190.0f, 100.0f, // VG_LINE_TO_ABS
                         120.0f, 240.0f }; // VG_LINE_TO_ABS
    VGfloat clear[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
    VGfloat color[4] = { 0.5f, 0.5f, 0.5f, 1.0f };
