...
HINSTANCE g_hInst;
LPSTR lpszClass="OVG PG: Sample 03_05";
...
{
    VGImage imageObj;
    imageObj = vgCreateImage( VG_sRGBA_8888, 240, 320,VG_IMAGE_QUALITY_BETTER );
    vgImageSubData( imageObj, cimg_flower, 240*4, VG_sRGBA_8888,0,0,240,320 );
    vgDrawImage( imageObj );
    vgDestroyImage( imageObj );
