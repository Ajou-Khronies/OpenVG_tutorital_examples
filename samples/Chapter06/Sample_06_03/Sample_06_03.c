...
HINSTANCE g_hInst;
LPSTR lpszClass="OVG PG: Sample 06_03";
...
int AppDisplay( void )
{
    ...
    VGfloat radialGradient[5] = { 120.0f, 160.0f, 110.0f, 140.0f, 30.0f };
    ...
    vgSetParameterfv( fillPaint, VG_PAINT_COLOR, 4, strokeColor);

    vgSetParameteri(fillPaint, VG_PAINT_TYPE, VG_PAINT_TYPE_RADIAL_GRADIENT);
    vgSetParameterfv(fillPaint, VG_PAINT_RADIAL_GRADIENT, 5, radialGradient);
    vgSetParameterfv(fillPaint, VG_PAINT_COLOR_RAMP_STOPS, 20, rampStops);
